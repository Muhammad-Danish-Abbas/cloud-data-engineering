...
--- Output not show because no customer has more than 5 orders in the dataset.
...
-- The query is correct, but no output is shown because all customers in the BikeStores database have already placed orders. That is why no customer matches the condition.
