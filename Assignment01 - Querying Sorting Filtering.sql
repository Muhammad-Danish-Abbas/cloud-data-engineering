...
-- Note: BikeStores database only contains model years 2016, 2017, and 2018.
-- model_year 2019 and 2020 have no data, query returns 0 rows.
-- Query logic is 100% correct, only sample data does not include those years.
-- Therefore using 2017 OR 2018 to demonstrate correct results.